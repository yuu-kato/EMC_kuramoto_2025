...
int main() {
    ...
    ofstream Data_out5("./output_files_kuramoto_rep/data.csv");
    ...
    Data_out5 << "oscillator_number" << "," << "seed" << ",";
    ...
    for (int NUM=0; NUM < M_num; NUM++){
        ...
        for (int num=0; num<repeat_num; num++){
            ...
            if (EMC_count == 1) {
                for (int n = 0; n < (N-1); n++){
                    Data_out5 << t_data.at(n) << ",";
                }
                Data_out5 << t_data.at(N-1) << endl;
            }
            Data_out5 << M << "," << EMC_count << ",";
            for (int n = 0; n < (N-1); n++){
                Data_out5 << R_data.at(n) << ",";
            }
            Data_out5 << R_data.at(N-1) << endl;
