...
// The case when oscillator number = 1000
...
void EMC(int L, const vector<double> &b, int N, const vector<double> &t_data, const vector<double> &R_data, vector<vector<double>> s, int simulation_size, int burn_in, double target_accept, double range_accept, int seed, int exchange_freq, double alpha_gamma, double beta_gamma, double alpha_delta_gamma, double beta_delta_gamma, ofstream &fout_ext){
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ofstream fout_1("./output_files_kuramoto_n1000_error/parameter.csv");
    fout_1 << "mc_step" << ",";
    for (int l = 0; l < L; l++){
    ...
    ofstream fout_3("./output_files_kuramoto_n1000_error/exchange_rate.csv");
    ofstream fout_4("./output_files_kuramoto_n1000_error/acceptance_rate.csv");
    ofstream fout_5("./output_files_kuramoto_n1000_error/step_size.csv");
    fout_3 << "mc_step" << ",";
    fout_4 << "mc_step" << ",";
    fout_5 << "mc_step" << ",";
    for (int l = 0; l < L; l++) {
    ...
    ofstream fout_6("./output_files_kuramoto_n1000_error/MAP.csv");
    fout_6 << "l" << ",";
    for (int i = 0; i < L; i++) {
        fout_6 << i << ",";
    }
    ...
    ofstream fout_7("./output_files_kuramoto_n1000_error/free_energy.txt");
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main() {
    ...
    // output files
    mkdir("./output_files_kuramoto_n1000_error", 0755); // 0755 means 'allowing the owner to write, read, execute, while allowing others only to read and execute'
    ofstream fout_1("./output_files_kuramoto_n1000_error/data.txt");
    ofstream fout_2("./output_files_kuramoto_n1000_error/true_parameters.csv");
    ofstream fout_3("./output_files_kuramoto_n1000_error/error.csv");
    ...
    int M = 1000; // number of oscillators
    int N = 101; // number of data points
    double t_max = 50.0; // max time
    double dt = 0.001; 
    int seed = 2419; // seed of random number
