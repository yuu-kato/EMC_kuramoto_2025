...
- For C++ and Python codes, the simulation environment can be reproduced by Docker or Apptainer. 
- For the brief tutorial of Docker and Apptainer, see the section "How to use Docker" and "How to use Apptainer". 
...
The simulation results in `plot/results` directory were calculated using the scripts named `EMC_something.cpp` or `something.cpp` on HPC with Apptainer. 
...
- The directory `output_files_something` coppresponds to the simulation results of `EMC_something.cpp` or `something.cpp`. 
